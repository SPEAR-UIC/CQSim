...
def  cqsim_main(para_list):
    ...
    print(".................... Value Model")
    value_model = Class_Reinforcement_learning.ValueModel(debug=module_debug, input_dim_str = para_list['input_dim'], job_cols=job_cols, hidden_dim_str = para_list['hidden_dim'], node_module=module_node_struc, window_size = window_size)

    # run model once to trigger TF to build the model
    input_dim = [module_node_struc.get_tot()+job_cols, int(para_list['input_dim'])]
