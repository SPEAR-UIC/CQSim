...
class Job_trace:
    ...
    def wait_core_seconds(self):
        return self.job_wait_core_seconds
    ...
    def update_reservation_flag(self, job_index):
        self.jobTrace[job_index]['backfill'] = 2
    ...
    def job_submit (self, job_index, job_score = 0, job_est_start = -1):
        ...
        self.job_wait_core_seconds += int(self.jobTrace[job_index]["reqProc"]*self.jobTrace[job_index]["reqTime"])
        return 1
    
    def job_start (self, job_index, time, backfill):
        ...
        if self.jobTrace[job_index]['backfill'] != 2:
            if backfill:
                self.jobTrace[job_index]['backfill'] = 0
            else:
                self.jobTrace[job_index]['backfill'] = 1
